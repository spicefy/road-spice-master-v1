                ...
                <div class="row">
                    ...
                    <?php for ($i = 1; $i <= 3; $i++) : ?>
                        <?php if (has_nav_menu('footer_column_' . $i)) : ?>
                            <?php
                                // Set column width: Quick Links = 2, Our Programs = 4, Others = 2
                                $column_class = 'col-lg-2';
                                if ($i === 2) {
                                    $column_class = 'col-lg-4';
                                }
                            ?>
                            <div class="<?php echo esc_attr($column_class); ?> col-md-6 mb-4 footer-links">
                                <h5><?php echo esc_html(get_theme_mod('footer_column_' . $i . '_title', $i === 1 ? 'Quick Links' : ($i === 2 ? 'Our Programs' : 'More Info'))); ?></h5>
                                <?php
                                wp_nav_menu(array(
                    ...
                    <!-- Contact Info Column -->
                    <div class="col-lg-2 col-md-6 mb-4 footer-links ms-lg-auto">
